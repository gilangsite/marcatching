...
const primaryLinks = [
  ...
  { href: '#ecosystem', label: 'Testimonials', section: 'ecosystem' },
    ...
    <nav className={`${styles.nav} ${pageProgress > 0.012 ? styles.scrolled : ''} ${open ? styles.menuOpen : ''}`} aria-label="Primary navigation">
      <div className={styles.inner}>
        ...
        <div className={styles.desktopLinks}>
          ...
          <Link href={ctaUrl} className={styles.navCta}>Enter Dashboard</Link>
        </div>
        ...
        <div className={styles.mobilePanel} id="experience-mobile-menu" aria-hidden={!open}>
          <div className={styles.mobilePrimary}>
            ...
            <Link href={ctaUrl} className={styles.mobileLink} onClick={() => setOpen(false)}>Enter Dashboard</Link>
          </div>
