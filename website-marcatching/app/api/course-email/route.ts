...
const APPS_SCRIPT_URL = process.env.NEXT_PUBLIC_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbxEiTGuWT2NKvLR61qsQpEIfrIasu5T1yowItgodpNWkh8Tt_ouljIVnyM4KPzE0YRb/exec'
